...
for (const color of colorsBase.shades_neutral) {
...
for (const color of colorsBase.shades_vibrant) {
...
for (const color of colorsBase.light_dark) {
...
for (const color of colorsBase.standalone) {
  colorTokens.items.push({
    name: color.name,
    value: color.value
  });
